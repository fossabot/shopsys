...
kubectl exec --namespace=${JOB_NAME} ${PHP_FPM_POD} ./phing clean dirs-create backend-api-install backend-api-oauth-keys-generate elasticsearch-recreate-structure product-search-export-products grunt error-pages-generate
