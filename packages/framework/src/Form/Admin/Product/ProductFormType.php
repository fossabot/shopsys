...
class ProductFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $this->disabledFieldsOptionsIndexedByFieldName = $this->getDisabledFieldsOptionsIndexedByFieldName($editedProduct);

        if ($editedProduct !== null && $editedProduct->isVariant()) {
