...
class EntityNameResolverTest extends TestCase
{
    ...
    public function resolvingProvider()
    {
        return [
            'empty map' => [
                'map' => [],
     ...
     */
    public function testResolving(array $map, string $value, string $expected)
    {
     ...
     */
    public function testResolvingInStrings(array $map, $value, $expected)
    {
        $entityNameResolver = new EntityNameResolver($map);
    ...
    public function testResolvingInNull()
    {
    ...
    public function testResolvingInArray()
    {
        $entityNameResolver = new EntityNameResolver([
            'Shopsys\FrameworkBundle\Model\Entity' => 'Shopsys\ShopBundle\Model\MyEntity',
            'Shopsys\FrameworkBundle\Model\OtherEntity' => 'Shopsys\ShopBundle\Model\MyOtherEntity',
    ...
    public function testResolvingInPropertiesReturnsSameObject()
    {
        $entityNameResolver = new EntityNameResolver([
            'Shopsys\FrameworkBundle\Model\Entity' => 'Shopsys\ShopBundle\Model\MyEntity',
        ]);
    ...
    public function testResolvingInPublicProperty()
    {
        $entityNameResolver = new EntityNameResolver([
            'Shopsys\FrameworkBundle\Model\Entity' => 'Shopsys\ShopBundle\Model\MyEntity',
        ]);
    ...
    public function testResolvingInPrivateProperty()
    {
        $entityNameResolver = new EntityNameResolver([
            'Shopsys\FrameworkBundle\Model\Entity' => 'Shopsys\ShopBundle\Model\MyEntity',
        ]);
    ...
    public function testResolvingInPropertiesRecursively()
    {
        $entityNameResolver = new EntityNameResolver([
            'Shopsys\FrameworkBundle\Model\Entity' => 'Shopsys\ShopBundle\Model\MyEntity',
        ]);
    ...
    public function testResolvingInMultipleProperties()
    {
        $entityNameResolver = new EntityNameResolver([
            'Shopsys\FrameworkBundle\Model\Entity' => 'Shopsys\ShopBundle\Model\MyEntity',
        ]);
